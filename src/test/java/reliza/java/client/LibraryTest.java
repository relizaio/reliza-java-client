...
/**
 * Class for testing Library methods
 */
public class LibraryTest {
    ...
    @Test public void testAddRelease() {
        Flags flags = Flags.builder().apiKeyId("PROJECT__6ba5691c-05e3-4ecd-a45a-18b382419f40")
            ...
            .artCiMeta("Github Actions").artCiMeta("Github Actions")
            .artGroup("io.reliza").artGroup("io.reliza")
            .artId("relizaio/reliza-cli").artId("relizaio/reliza-cli")
            .artPackage("DOCKER").artPackage("DOCKER")
            .artPublisher("Rasa").artPublisher("Rasa")
            .artType("Docker").artType("Docker")
            .dateActual("2021-01-11T19:43:32.286086002Z")
            .dateEnd("2021-01-12T19:43:32.286086002Z").dateEnd("2021-01-12T19:43:32.286086002Z")
            .dateStart("2021-01-11T19:43:32.286086002Z").dateStart("2021-01-11T19:43:32.286086002Z")
            .endPoint("https://github.com/relizaio/reliza-java-client")
            .status("completed")
            .tagKeyArr("prod").tagKeyArr("prod")
            .tagValArr("true").tagValArr("true")
            .vcsType("git").build();
        Library library = new Library(flags);
        library.addRelease();
    }
    ...
    @Test public void testInstDataImagesString() {
      Flags flags = Flags.builder().apiKeyId("INSTANCE__ff253dbd-9654-4a39-963b-15f16b003f61")
          ...
          .imagesString("sha256:poke").build();
      Library library = new Library(flags);
      library.instData();
    }
